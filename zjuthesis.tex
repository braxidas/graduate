...
\documentclass[
    ...
    % Title
    Title           = 云原生微隔离策略自动生成系统,
    TitleEng        = {{Automated Generation System for Cloud-Native Micro-Segmentation Policies}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
% \titletwolines{毕业论文题目第一行}{毕业论文题目第二行}
\titleengtwolines{Automated Generation System for}{Cloud-Native Micro-Segmentation Policies}
